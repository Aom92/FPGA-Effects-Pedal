...
//   output_name:        alt_sld_fab_alt_sld_fab_trfabric_capture_mux0
//   use_packets:        true
//   use_empty:          1
//   empty_width:        2
//   data_width:         32
...
module alt_sld_fab_alt_sld_fab_trfabric_capture_mux0 (     
// Interface: out
...
endcase // case (select)
   ...
   //| output Pipeline
   // ---------------------------------------------------------------------
   alt_sld_fab_alt_sld_fab_trfabric_capture_mux0_1stage_pipeline  #( .PAYLOAD_WIDTH( 36 + 1 ) ) outpipe
              ( .clk      (clk ),
                .reset_n  (reset_n  ),
...
//  --------------------------------------------------------------------------------
module alt_sld_fab_alt_sld_fab_trfabric_capture_mux0_1stage_pipeline
