// Effect_Pedal_ADC_0_modular_adc_0.v
...
`timescale 1 ps / 1 ps
module Effect_Pedal_ADC_0_modular_adc_0 #(
	...
	Effect_Pedal_ADC_0_modular_adc_0_adc_monitor_internal #(
		.ADC_DATA_WIDTH        (12),
		.ADC_CHANNEL_WIDTH     (5),
	...
	Effect_Pedal_ADC_0_modular_adc_0_avalon_st_adapter #(
		.inBitsPerSymbol (12),
		.inUsePackets    (1),
		.inDataWidth     (12),
		.inChannelWidth  (5),
	...
	Effect_Pedal_ADC_0_modular_adc_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (12),
		.inUsePackets    (1),
		.inDataWidth     (12),
		.inChannelWidth  (5),
