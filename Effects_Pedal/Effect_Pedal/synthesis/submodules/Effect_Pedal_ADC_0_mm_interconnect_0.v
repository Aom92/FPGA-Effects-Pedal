// Effect_Pedal_ADC_0_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module Effect_Pedal_ADC_0_mm_interconnect_0 (
		input  wire        altpll_0_c0_clk,                                                  //                                                altpll_0_c0.clk
		input  wire        clk_0_clk_clk,                                                    //                                                  clk_0_clk.clk
		input  wire        AvalonBridge_clk_reset_reset_bridge_in_reset_reset,               //               AvalonBridge_clk_reset_reset_bridge_in_reset.reset
		input  wire        AvalonBridge_master_translator_reset_reset_bridge_in_reset_reset, // AvalonBridge_master_translator_reset_reset_bridge_in_reset.reset
		input  wire        modular_adc_0_reset_sink_reset_bridge_in_reset_reset,             //             modular_adc_0_reset_sink_reset_bridge_in_reset.reset
		input  wire [31:0] AvalonBridge_master_address,                                      //                                        AvalonBridge_master.address
		output wire        AvalonBridge_master_waitrequest,                                  //                                                           .waitrequest
		input  wire [3:0]  AvalonBridge_master_byteenable,                                   //                                                           .byteenable
		input  wire        AvalonBridge_master_read,                                         //                                                           .read
		output wire [31:0] AvalonBridge_master_readdata,                                     //                                                           .readdata
		output wire        AvalonBridge_master_readdatavalid,                                //                                                           .readdatavalid
		input  wire        AvalonBridge_master_write,                                        //                                                           .write
		input  wire [31:0] AvalonBridge_master_writedata,                                    //                                                           .writedata
	...
	wire          avalonbridge_master_translator_avalon_universal_master_0_waitrequest;   // AvalonBridge_master_agent:av_waitrequest -> AvalonBridge_master_translator:uav_waitrequest
	wire   [31:0] avalonbridge_master_translator_avalon_universal_master_0_readdata;      // AvalonBridge_master_agent:av_readdata -> AvalonBridge_master_translator:uav_readdata
	wire          avalonbridge_master_translator_avalon_universal_master_0_debugaccess;   // AvalonBridge_master_translator:uav_debugaccess -> AvalonBridge_master_agent:av_debugaccess
	wire   [31:0] avalonbridge_master_translator_avalon_universal_master_0_address;       // AvalonBridge_master_translator:uav_address -> AvalonBridge_master_agent:av_address
	wire          avalonbridge_master_translator_avalon_universal_master_0_read;          // AvalonBridge_master_translator:uav_read -> AvalonBridge_master_agent:av_read
	wire    [3:0] avalonbridge_master_translator_avalon_universal_master_0_byteenable;    // AvalonBridge_master_translator:uav_byteenable -> AvalonBridge_master_agent:av_byteenable
	wire          avalonbridge_master_translator_avalon_universal_master_0_readdatavalid; // AvalonBridge_master_agent:av_readdatavalid -> AvalonBridge_master_translator:uav_readdatavalid
	wire          avalonbridge_master_translator_avalon_universal_master_0_lock;          // AvalonBridge_master_translator:uav_lock -> AvalonBridge_master_agent:av_lock
	wire          avalonbridge_master_translator_avalon_universal_master_0_write;         // AvalonBridge_master_translator:uav_write -> AvalonBridge_master_agent:av_write
	wire   [31:0] avalonbridge_master_translator_avalon_universal_master_0_writedata;     // AvalonBridge_master_translator:uav_writedata -> AvalonBridge_master_agent:av_writedata
	wire    [2:0] avalonbridge_master_translator_avalon_universal_master_0_burstcount;    // AvalonBridge_master_translator:uav_burstcount -> AvalonBridge_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                      // rsp_mux:src_valid -> AvalonBridge_master_agent:rp_valid
	wire  [101:0] rsp_mux_src_data;                                                       // rsp_mux:src_data -> AvalonBridge_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                      // AvalonBridge_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                    // rsp_mux:src_channel -> AvalonBridge_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                              // rsp_mux:src_startofpacket -> AvalonBridge_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                // rsp_mux:src_endofpacket -> AvalonBridge_master_agent:rp_endofpacket
	...
	wire    [0:0] cmd_mux_src_channel;                                                    // cmd_mux:src_channel -> modular_adc_0_sequencer_csr_agent:cp_channel
	...
	wire          avalonbridge_master_agent_cp_valid;                                     // AvalonBridge_master_agent:cp_valid -> router:sink_valid
	wire  [101:0] avalonbridge_master_agent_cp_data;                                      // AvalonBridge_master_agent:cp_data -> router:sink_data
	wire          avalonbridge_master_agent_cp_ready;                                     // router:sink_ready -> AvalonBridge_master_agent:cp_ready
	wire          avalonbridge_master_agent_cp_startofpacket;                             // AvalonBridge_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          avalonbridge_master_agent_cp_endofpacket;                               // AvalonBridge_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          modular_adc_0_sequencer_csr_agent_rp_valid;                             // modular_adc_0_sequencer_csr_agent:rp_valid -> router_001:sink_valid
	wire  [101:0] modular_adc_0_sequencer_csr_agent_rp_data;                              // modular_adc_0_sequencer_csr_agent:rp_data -> router_001:sink_data
	wire          modular_adc_0_sequencer_csr_agent_rp_ready;                             // router_001:sink_ready -> modular_adc_0_sequencer_csr_agent:rp_ready
	wire          modular_adc_0_sequencer_csr_agent_rp_startofpacket;                     // modular_adc_0_sequencer_csr_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          modular_adc_0_sequencer_csr_agent_rp_endofpacket;                       // modular_adc_0_sequencer_csr_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [101:0] rsp_demux_src0_data;                                                    // rsp_demux:src0_data -> crosser_001:in_data
	...
	wire  [101:0] crosser_001_out_data;                                                   // crosser_001:out_data -> rsp_mux:sink0_data
	...
	wire          modular_adc_0_sequencer_csr_agent_rdata_fifo_out_valid;                 // modular_adc_0_sequencer_csr_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] modular_adc_0_sequencer_csr_agent_rdata_fifo_out_data;                  // modular_adc_0_sequencer_csr_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          modular_adc_0_sequencer_csr_agent_rdata_fifo_out_ready;                 // avalon_st_adapter:in_0_ready -> modular_adc_0_sequencer_csr_agent_rdata_fifo:out_ready
	...
	) avalonbridge_master_translator (
		.clk                    (altpll_0_c0_clk),                                                        //                       clk.clk
		.reset                  (AvalonBridge_master_translator_reset_reset_bridge_in_reset_reset),       //                     reset.reset
		.uav_address            (avalonbridge_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (avalonbridge_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (avalonbridge_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (avalonbridge_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (avalonbridge_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (avalonbridge_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (avalonbridge_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (avalonbridge_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (avalonbridge_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (avalonbridge_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (avalonbridge_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (AvalonBridge_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (AvalonBridge_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (AvalonBridge_master_byteenable),                                         //                          .byteenable
		.av_read                (AvalonBridge_master_read),                                               //                          .read
		.av_readdata            (AvalonBridge_master_readdata),                                           //                          .readdata
		.av_readdatavalid       (AvalonBridge_master_readdatavalid),                                      //                          .readdatavalid
		.av_write               (AvalonBridge_master_write),                                              //                          .write
		.av_writedata           (AvalonBridge_master_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) avalonbridge_master_agent (
		.clk                   (altpll_0_c0_clk),                                                        //       clk.clk
		.reset                 (AvalonBridge_master_translator_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.av_address            (avalonbridge_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (avalonbridge_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (avalonbridge_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (avalonbridge_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (avalonbridge_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (avalonbridge_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (avalonbridge_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (avalonbridge_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (avalonbridge_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (avalonbridge_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (avalonbridge_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (avalonbridge_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (avalonbridge_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (avalonbridge_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (avalonbridge_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (avalonbridge_master_agent_cp_ready),                                     //          .ready
	...
	Effect_Pedal_ADC_0_mm_interconnect_0_router router (
		.sink_ready         (avalonbridge_master_agent_cp_ready),                               //      sink.ready
		.sink_valid         (avalonbridge_master_agent_cp_valid),                               //          .valid
		.sink_data          (avalonbridge_master_agent_cp_data),                                //          .data
		.sink_startofpacket (avalonbridge_master_agent_cp_startofpacket),                       //          .startofpacket
		.sink_endofpacket   (avalonbridge_master_agent_cp_endofpacket),                         //          .endofpacket
		.clk                (altpll_0_c0_clk),                                                  //       clk.clk
		.reset              (AvalonBridge_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Effect_Pedal_ADC_0_mm_interconnect_0_router_001 router_001 (
	...
	Effect_Pedal_ADC_0_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (altpll_0_c0_clk),                                                  //       clk.clk
		.reset              (AvalonBridge_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Effect_Pedal_ADC_0_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                        //       clk.clk
		.reset               (modular_adc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Effect_Pedal_ADC_0_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                        //       clk.clk
		.reset              (modular_adc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Effect_Pedal_ADC_0_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (altpll_0_c0_clk),                                                  //       clk.clk
		.reset               (AvalonBridge_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (AvalonBridge_master_translator_reset_reset_bridge_in_reset_reset), //  in_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (AvalonBridge_master_translator_reset_reset_bridge_in_reset_reset), // out_clk_reset.reset
	...
	Effect_Pedal_ADC_0_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
