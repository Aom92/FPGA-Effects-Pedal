...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/DOWNSAMPLER_fir_compiler_ii_0_rtl_core_u0_m0_wo0_cm0_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/DOWNSAMPLER_fir_compiler_ii_0_rtl_core.vhd"      -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/DOWNSAMPLER_fir_compiler_ii_0_ast.vhd"           -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/DOWNSAMPLER_fir_compiler_ii_0.vhd"               -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/DOWNSAMPLER_fir_compiler_ii_0_tb.vhd"            -work fir_compiler_ii_0 -cdslib ./cds_libs/fir_compiler_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/DOWNSAMPLER.vhd"                                                                                                                
fi
