...
# ----------------------------------------
# If DOWNSAMPLER is one of several IP cores in your
...
# ----------------------------------------
# ACDS 20.1 720 win32 2023.05.17.01:33:59
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "DOWNSAMPLER"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/DOWNSAMPLER_fir_compiler_ii_0_rtl_core_u0_m0_wo0_cm0_lutmem.hex ./
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/submodules/DOWNSAMPLER_fir_compiler_ii_0_rtl_core.vhd"      -work fir_compiler_ii_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/submodules/DOWNSAMPLER_fir_compiler_ii_0_ast.vhd"           -work fir_compiler_ii_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/submodules/DOWNSAMPLER_fir_compiler_ii_0.vhd"               -work fir_compiler_ii_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/submodules/DOWNSAMPLER_fir_compiler_ii_0_tb.vhd"            -work fir_compiler_ii_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/DOWNSAMPLER.vhd"                                                                   
}
