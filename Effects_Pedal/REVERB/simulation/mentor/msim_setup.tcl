...
alias file_copy {
  ...
  file copy -force $QSYS_SIMDIR/submodules/REVERB_fir_compiler_ii_0_rtl_core_u0_m0_wo0_cm78_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/submodules/REVERB_fir_compiler_ii_0_rtl_core_u0_m0_wo0_cm79_lutmem.hex ./
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/submodules/REVERB_fir_compiler_ii_0_rtl_core.vhd"           -work fir_compiler_ii_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/submodules/REVERB_fir_compiler_ii_0_ast.vhd"                -work fir_compiler_ii_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/submodules/REVERB_fir_compiler_ii_0.vhd"                    -work fir_compiler_ii_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/submodules/REVERB_fir_compiler_ii_0_tb.vhd"                 -work fir_compiler_ii_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/REVERB.vhd"                                                                        
}
