...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADC_modular_adc_0.vhd"                    -work modular_adc_0    -cdslib ./cds_libs/modular_adc_0.cds.lib   
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADC_altpll_0.vho"                         -work altpll_0         -cdslib ./cds_libs/altpll_0.cds.lib        
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ADC.vhd"                                                                                                               
fi
